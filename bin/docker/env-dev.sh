...
sed -i "s/SERVER_URL=http:\/\/localhost:8000/SERVER_URL=$3/" ".env.docker.dev"
...
sed -i "s/SERVER_URL=http:\/\/localhost:8000/SERVER_URL=http:\/\/localhost:8000/" ".env.dev"
sed -i "s/CLIENT_URL=http:\/\/localhost:3000/CLIENT_URL=$4/" ".env.dev"
