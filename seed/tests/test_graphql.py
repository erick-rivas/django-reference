        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 2697.0, "dominant_leg_accuracy": 7199.0}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 1068.0, "dominant_leg": "molestias, Lorem dolor Lorem magnam, magnam, elit.", "dominant_leg_accuracy": 4259.0}""",
                    details: "{}",
