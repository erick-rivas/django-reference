        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 8534.0, "dominant_leg": "Hic nunc Lorem exercitationem magnam, veniam Enim", "dominant_leg_accuracy": 4963.0}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 4814.0, "dominant_leg": "adipisicing Hic"}""",
                    details: "{}",
