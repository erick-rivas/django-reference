        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 9660.0, "dominant_leg_accuracy": 3959.0}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 3596.0, "dominant_leg": "enim tellus. placeat cursus", "dominant_leg_accuracy": 1607.0}""",
                    details: "{}",
