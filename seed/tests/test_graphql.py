        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 9494.0, "dominant_leg": "vehicula repellendus"}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 637.0, "dominant_leg": "Hic congue. libero Lorem Lorem veniam", "dominant_leg_accuracy": 706.0}""",
                    details: "{}",
