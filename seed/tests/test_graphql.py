        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 8456.0, "dominant_leg_accuracy": 795.0}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 5546.0, "dominant_leg": "esse accusantium exercitationem", "dominant_leg_accuracy": 3132.0}""",
                    details: "{}",
