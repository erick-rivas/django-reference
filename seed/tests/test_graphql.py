        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 6645.0, "dominant_leg": ""}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 8655.0, "dominant_leg": "veniam nec nunc ipsum adipisicing ipsum, Hic elit.", "dominant_leg_accuracy": 1381.0}""",
                    details: "{}",
