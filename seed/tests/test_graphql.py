        ...
        response = self.query(
            ...
            mutation {
                savePlayerPosition(
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 6122.0, "dominant_leg": "molestias, vehicula reiciendis Lorem magnam, elit.", "dominant_leg_accuracy": 7777.0}""",
                    details: "{}",
                ) {
                    playerPosition {
                        id
        ...
        response = self.query(
            ...
            mutation {
                setPlayerPosition(id:1
                    name: "",
                    code: "",
                    stats: """{"expected_goals": 4488.0, "dominant_leg": "vitae ipsum,"}""",
                    details: "{}",
