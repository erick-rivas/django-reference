...
Copy seed/docs/assets/aws-code-deploy/.env.example to root project and rename to **.aws.env**. 
...
Then execute `seed/docs/assets/aws-code-deploy/configure.sh` to set cli keys
